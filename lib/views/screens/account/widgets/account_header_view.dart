...
class AccountHeaderView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      height: 200, padding: const EdgeInsets.symmetric(vertical: 10), color: AppColors.white,
      child: Column(
        children: [
          Container(
              ...
              children: [
                Column(
                  ...
                  children: const [
                    CircleAvatar(
                      ...
                      radius: 36,
                      backgroundImage: NetworkImage("https://cdn.dribbble.com/users/1782018/screenshots/4592002/dribble_shot.jpg"),
                    ),
                    SizedBox(height: 12),
                    Text("Naser"),
                    Text("User Id 664715"),
                ...
                Column(
                  children: [
                    ...
                    _buttonView(() {}, AppColors.mainBlue, "Open Shop", AppColors.white),
                  ],
                ),
              ],
            ),
  ...
  _bottomView(String value, String title) {
    return Column(
      children: [
        CustomText(title: value, fontSize: 15, fontColor: AppColors.black, fontWeight: FontWeight.bold),
